...
int tlv__to_u16(struct TlvScan* scan, uint8_t tag, uint16_t* val);
int tlv__to_u32(struct TlvScan* scan, uint8_t tag, uint32_t* val);
int tlv__to_data(struct TlvScan* scan, uint8_t tag, uint8_t* data, uint8_t data_size);
int tlv__to_data_exact(struct TlvScan* scan, uint8_t tag, uint8_t* data, uint8_t data_size);
